...
def test_run_add_bis(setup_mock):
    sut = Controller()
...
def test_run_add_bis_another(setup_mock):
    sut = Controller()
...
def test_run_allfunctions(setup_mock):
    sut = Controller()
